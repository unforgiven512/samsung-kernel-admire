...
// disys 20100613 HW03 key gpio
static unsigned int keypad_row_gpios_escape[] = {72, 73, 3, 33, 74, 26, 90, 122, 96, 106, 108, 123};  //keyscan
static unsigned int keypad_col_gpios_escape[] = {21, 36, 40, 92, 78, 91};  //keysense
// HW02 key gpio
static unsigned int keypad_row_gpios_escape_REV02[] = {72, 73, 92, 40, 21, 26, 90, 94, 96, 106, 108, 123};  //keyscan
static unsigned int keypad_col_gpios_escape_REV02[] = {33, 74, 3, 122, 36, 91};  //keysense
...
/* ESCAPE keypad platform device information */
static struct gpio_event_matrix_info escape_keypad_matrix_info_REV02 = {
	.info.func	= gpio_event_matrix_func,
	.keymap		= keypad_keymap_escape,
	.output_gpios	= keypad_row_gpios_escape_REV02,
	.input_gpios	= keypad_col_gpios_escape_REV02,
	.noutputs	= ARRAY_SIZE(keypad_row_gpios_escape_REV02),
	.ninputs	= ARRAY_SIZE(keypad_col_gpios_escape_REV02),
	.settle_time.tv.nsec = 100 * NSEC_PER_USEC,
	.poll_time.tv.nsec = 40 * NSEC_PER_MSEC,
	.flags		=GPIOKPF_ACTIVE_HIGH| GPIOKPF_DRIVE_INACTIVE|GPIOKPF_PRINT_MAPPED_KEYS|GPIOKPF_REMOVE_PHANTOM_KEYS
...
static struct gpio_event_info *escape_keypad_info_REV02[] = {
	&escape_keypad_matrix_info_REV02.info
};
...
static struct gpio_event_platform_data escape_keypad_data_REV02 = {
	.name		= "escape-keypad",
	.info		= escape_keypad_info_REV02,
	.info_count	= ARRAY_SIZE(escape_keypad_info_REV02)
};
...
struct platform_device keypad_device_escape_REV02 = {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &escape_keypad_data_REV02,
	},
};
