...
out:
	...
	if ((host->caps & MMC_CAP_NEEDS_POLL) || (host->index==0 && err && !gpio_get_value(96))) // T_FLASH_DETECT
#elif defined(CONFIG_MACH_ROOKIE) || defined(CONFIG_MACH_ESCAPE)
	if ((host->caps & MMC_CAP_NEEDS_POLL) || (host->index==0 && err && !gpio_get_value(37))) // T_FLASH_DETECT
#else
	if ((host->caps & MMC_CAP_NEEDS_POLL) || (host->index==0 && err && !gpio_get_value(37))) // T_FLASH_DETECT
#endif
