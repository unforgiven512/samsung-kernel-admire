...
#if defined(CONFIG_MACH_RANT3) || defined(CONFIG_MACH_REALITY2) || defined(CONFIG_MACH_VINO) || defined(CONFIG_MACH_ROOKIE) || defined(CONFIG_MACH_ESCAPE) || defined(CONFIG_MACH_GIO)
...
static DEVICE_ATTR(key_pressed, S_IRUGO | S_IWUSR | S_IWGRP /*S_IWUGO*/, keyshort_test, NULL);
...
#else
static struct device_attribute bl_keypad_attributes[] = {
        __ATTR(keypad_bl_time, 0775, keypad_backlight_time_show, keypad_backlight_time_store),
};
#endif
#endif
...
#elif defined(CONFIG_MACH_GIO)
	static int capture_keys[NUM_CAPTURE_KEYS]={102, 115, 116}; //cha Home + Volume up+ Pwr Key
#else
...
err_request_slide_irq_failed:
		free_irq(gpio_to_irq(HALL_GPIO), kp);
#endif
	}
	return err;
}
...
#if defined(CONFIG_MACH_RANT3) || defined(CONFIG_MACH_REALITY2) || defined(CONFIG_MACH_ROOKIE) || defined(CONFIG_MACH_ESCAPE) || defined(CONFIG_MACH_GIO)
